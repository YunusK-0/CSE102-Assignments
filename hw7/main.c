        ...
        else
        {
          ...
          //  printf("geldim %ld %d\n",strlen(gelen),num2);
            ...
            if(board[num1][num2] == gelen[0] && strlen(gelen)+ num2 <16 && board[num1][num2+1] == gelen[1]) // from left to right horizontally
            {
                ...
                if(i ==strlen(gelen))
                {
                    if(comp(words,gelen) == 0)
                    {
                        for(; k> 0; copy_num2++,k--)
                        {
                            board[copy_num1][copy_num2]='X';
                        }
                        point += 2;
            ...
            else if(board[num1][num2] == gelen[0] && num2-strlen(gelen) >= 0 && board[num1][num2-1] == gelen[1]) // from right to left horizontally
            {
                for(;i<strlen(gelen); i++,num2--,k++)  // the same algorithm was used for all of them so 1 time explain is enough...........
            ...
            else if(board[num1][num2] == gelen[0] && num1+strlen(gelen) <= 15 && board[num1+1][num2] == gelen[1]) // from up to down vertically
            {
                for(;i<strlen(gelen); i++,num1++,k++)
                {
                    if(board[num1][num2]== gelen[i])
                    {
                        dogruluk[k] = gelen[i];
            ...
            else if(board[num1][num2] == gelen[0] && num1-strlen(gelen) >= 0 && board[num1-1][num2] == gelen[1]) // from down to up vertically
            {
                for(;i<strlen(gelen); i++,num1--,k++)
                {
                    if(board[num1][num2]== gelen[i])
            ...
            else if(board[num1][num2] == gelen[0] && num1-strlen(gelen) >= 0 &&num2 + strlen(gelen) <= 15 && board[num1-1][num2+1] == gelen[1]) // upper right cross
            {
                for(;i<strlen(gelen); i++,num1--,num2++,k++)
                {
                    if(board[num1][num2]== gelen[i])
                    {
                        dogruluk[k] = gelen[i];
            ...
            else if(board[num1][num2] == gelen[0] && num1+strlen(gelen) <= 15 &&num2 - strlen(gelen) >= 0 && board[num1+1][num2-1] == gelen[1]) // lower left cross
            {
                for(;i<strlen(gelen); i++,num1++,num2--,k++)
                {
                    if(board[num1][num2]== gelen[i])
            ...
            else if(board[num1][num2] == gelen[0] && num1+strlen(gelen) <= 15 &&num2 + strlen(gelen) <= 15 && board[num1+1][num2+1] == gelen[1]) // lower right cross
            {
                for(;i<strlen(gelen); i++,num1++,num2++,k++)
                {
                    if(board[num1][num2]== gelen[i])
            ...
            else if(board[num1][num2] == gelen[0] && num1-strlen(gelen) >= 0 &&num2 - strlen(gelen) >= 0 && board[num1-1][num2-1] == gelen[1]) // upper left cross
            {
                for(;i<strlen(gelen); i++,num1--,num2--,k++)
                {
                    if(board[num1][num2]== gelen[i])
